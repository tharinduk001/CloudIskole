  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-ink-muted mt-1 text-sm">
        Auto-awarded badges (Course Graduate, 7/30-day streaks) are seeded already — the
        app looks them up by slug, so keep those three as-is unless you also update the
        migration. Add more here for other achievements.
      </p>
